...
display IU_M, IU_D, FU_M, FU_D, rti, rtp, rtf, tm_io, td_io, tiu_imp0, tiu_dom0, nit0, factor_tax0;
...
display PMBAR0, ER0, cif0, tariff_m0, pmd0, pmd_iu0, pdd0, pdd_iu0;
...
display  factor_use, p_N0P_VA0, q_N0P_VA0;
...
* reduce tax on the labor factor of production for the agricultural goods
rtp('ty','h1') = 0.05;
rtp('ty','h2') = 0.05;
rtp('ty','h3') = 0.00;
...
put /;
put '--------------- After Reducing Tax on Labor ----------------------';
put/; put/;
...
put 'c1':<15,    put c_pi_N0C_HH.l('c1','h1'); put /;
put 'c1':<15,    put c_pi_N0C_HH.l('c1','h2'); put /;
put 'c1':<15,    put c_pi_N0C_HH.l('c1','h3'); put /;
put /;

put /;
put 'Gross Income'  put /;
put '---------------------------'  put /;
put 'c1':<15,    put sum(h,c_gross_income.l(h)); put /;
put /;
